...
<div class="mb-4">
    <section class="flex justify-around my-4 mx-4">
        <a href="{{ route('posts.own') }}" class="border border-green-600 rounded hover:opacity-75">
            <h2 class="font-bold text-lg my-5 ml-5">今週の気分</h2>
        </a>
        <a href="{{ route('weather.index') }}" class="border border-green-600 rounded hover:opacity-75">
            <h2 class="font-bold text-lg my-5 ml-5">今週の天気</h2>
        </a>
    </section>
    <hr class="border border-green-800">
    <section class="my-4">
